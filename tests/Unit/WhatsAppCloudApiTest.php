...
final class WhatsAppCloudApiTest extends TestCase
{
    ...
    public function test_send_text_message_requires_to_or_recipient()
    {
        $this->expectException(InvalidMessage::class);
        $this->expectExceptionMessage('Either `to` or `recipient` is required.');

        $this->whatsapp_app_cloud_api->sendTextMessage(null, 'Hello world');
    }
